...
# TODO: make this a cogmodule as well
...
class TBD(CogModule):
    ...
    def return_prog2(self, atomspace, commands, inheritance_set2=None):
        ...
        bbox_instance2.set_value(self.key_scene, data2)
        bbox_instance2.set_value(self.key_shape_scene, FloatValue(list(features.cpu().numpy().shape)))
        ...
        def final_exec(inheritance_set_2, link):
            ...
            conj2 = self.atomspace.add_link(types.AndLink, [*inheritance_set_2])
        ...
        if current.startswith('query'):
            ...
            feat_attention2 = self.extract_tensor(sub_prog1, self.key_attention,self. key_shape_attention)
